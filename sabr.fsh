/*
Uniforms
- mpass_texture: texture sampler
- color_texture_sz: size of the texture before rendering
*/
...
vec3 P1 = texture2D(mpass_texture, xyp_1_2_3.xw ).rgb;
vec3 P2 = texture2D(mpass_texture, xyp_1_2_3.yw ).rgb;
vec3 P3 = texture2D(mpass_texture, xyp_1_2_3.zw ).rgb;
vec3 P6 = texture2D(mpass_texture, xyp_6_7_8.xw ).rgb;
vec3 P7 = texture2D(mpass_texture, xyp_6_7_8.yw ).rgb;
vec3 P8 = texture2D(mpass_texture, xyp_6_7_8.zw ).rgb;
vec3 P11 = texture2D(mpass_texture, xyp_11_12_13.xw).rgb;
vec3 P12 = texture2D(mpass_texture, xyp_11_12_13.yw).rgb;
vec3 P13 = texture2D(mpass_texture, xyp_11_12_13.zw).rgb;
vec3 P16 = texture2D(mpass_texture, xyp_16_17_18.xw).rgb;
vec3 P17 = texture2D(mpass_texture, xyp_16_17_18.yw).rgb;
vec3 P18 = texture2D(mpass_texture, xyp_16_17_18.zw).rgb;
vec3 P21 = texture2D(mpass_texture, xyp_21_22_23.xw).rgb;
vec3 P22 = texture2D(mpass_texture, xyp_21_22_23.yw).rgb;
vec3 P23 = texture2D(mpass_texture, xyp_21_22_23.zw).rgb;
vec3 P5 = texture2D(mpass_texture, xyp_5_10_15.xy ).rgb;
vec3 P10 = texture2D(mpass_texture, xyp_5_10_15.xz ).rgb;
vec3 P15 = texture2D(mpass_texture, xyp_5_10_15.xw ).rgb;
vec3 P9 = texture2D(mpass_texture, xyp_9_14_9.xy ).rgb;
vec3 P14 = texture2D(mpass_texture, xyp_9_14_9.xz ).rgb;
vec3 P19 = texture2D(mpass_texture, xyp_9_14_9.xw ).rgb;
...
vec2 fp = fract(tc * color_texture_sz);
